import {
  C
} from "./chunk-IIJ54XYE.js";
import "./chunk-5WRI5ZAA.js";

// node_modules/vitessce/dist/lz4-06c5cf38.js
var EI = Object.defineProperty;
var iI = (p, Q, D) => Q in p ? EI(p, Q, { enumerable: true, configurable: true, writable: true, value: D }) : p[Q] = D;
...
var tI = (() => (typeof document < "u" && document.currentScript && document.currentScript.src, function(p = {}) {
  ...
  var P, CA = false, x, h, T, K, Y, f, EA, iA;
  function rA() {
    var A = P.buffer;
  ...
  function z(A) {
    var _a;
    throw (_a = Q.onAbort) == null ? void 0 : _a.call(Q, A), A = "Aborted(" + A + ")", J(A), CA = true, A = new WebAssembly.RuntimeError(A + ". Build with -sASSERTIONS for more info."), d(A), A;
  }
  ...
  function YA(A, I) {
    var B = H;
    return X || typeof WebAssembly.instantiateStreaming != "function" || aA(B) || SA(B) || typeof fetch != "function" ? sA(B, A, I) : fetch(B, { credentials: "same-origin" }).then((g) => WebAssembly.instantiateStreaming(g, A).then(I, function(C2) {
      return J(`wasm streaming compile failed: ${C2}`), J("falling back to ArrayBuffer instantiation"), sA(B, A, I);
    }));
  }
  var $ = (A) => {
    for (; 0 < A.length; )
  ...
  var DA = 0, hA, y = (A) => {
    ...
    var C2 = Array(A.length), i = [], r = 0;
    A.forEach((t, E) => {
      S.hasOwnProperty(t) ? C2[E] = S[t] : (i.push(t), v.hasOwnProperty(t) || (v[t] = []), v[t].push(() => {
        C2[E] = S[t], ++r, r === i.length && B(C2);
      }));
    }), i.length === 0 && B(C2);
  };
  function LA(A, I, B = {}) {
    ...
    S[A] = I, delete j[A], v.hasOwnProperty(A) && (I = v[A], delete v[A], I.forEach((C2) => C2()));
  }
  function N(A, I, B = {}) {
  ...
  var qA = (A, I) => {
    ...
    function B(i) {
      C2[i] || S[i] || (j[i] ? j[i].forEach(B) : (g.push(i), C2[i] = true));
    }
    var g = [], C2 = {};
  ...
  for (var RA = typeof TextDecoder < "u" ? new TextDecoder("utf8") : void 0, dA = typeof TextDecoder < "u" ? new TextDecoder("utf-16le") : void 0, $A = (A, I) => {
    ...
    for (var B = 0, g = ""; !(B >= I / 4); ) {
      ...
      if (C2 == 0)
        break;
      ++B, 65536 <= C2 ? (C2 -= 65536, g += String.fromCharCode(55296 | C2 >> 10, 56320 | C2 & 1023)) : g += String.fromCharCode(C2);
    }
    return g;
  }, BI = (A, I, B) => {
    ...
    for (var C2 = 0; C2 < A.length; ++C2) {
      var i = A.charCodeAt(C2);
      if (55296 <= i && 57343 >= i) {
        var r = A.charCodeAt(++C2);
  ...
  } }), l.B.push({ value: void 0 }, { value: null }, { value: true }, { value: false }), l.D = l.B.length, Q.count_emval_handles = () => {
...
` + g.replace(/^Error(:[^\n]*)?\n/, ""));
  ...
  var QI = { n: (A, I, B) => {
    ...
    I = y(I), N(A, { name: I, fromWireType: function(C2) {
      return !!C2;
    }, toWireType: function(C2, i) {
      return i ? B : g;
    }, argPackAdvance: 8, readValueFromPointer: function(C2) {
      return this.fromWireType(h[C2]);
    }, C: null });
  }, k: (A, I) => {
    ...
    I = y(I), N(A, { name: I, fromWireType: (g) => g, toWireType: (g, C2) => C2, argPackAdvance: 8, readValueFromPointer: ZA(I, B), C: null });
  }, d: (A, I, B, g, C2, i, r) => {
    var t = PA(I, B);
    A = y(A), A = VA(A), C2 = jA(g, C2), XA(A, function() {
      ...
      var s = E[1] !== null && false, F = FA(E), u = E[0].name !== "void";
      n = [vA, n, i, bA, E[0], E[1]];
      for (var c = 0; c < e - 2; ++c)
        n.push(E[c + 2]);
      if (!F)
...
`];
    ...
    if (I = y(I), C2 === -1 && (C2 = 4294967295), C2 = (t) => t, g === 0) {
      var i = 32 - 8 * B;
      C2 = (t) => t << i >>> i;
    }
    ...
    function g(i) {
      return new C2(x.buffer, f[i + 4 >> 2], f[i >> 2]);
    }
    var C2 = [Int8Array, Uint8Array, Int16Array, Uint16Array, Int32Array, Uint32Array, Float32Array, Float64Array][I];
    B = y(B), N(A, { name: B, fromWireType: g, argPackAdvance: 8, readValueFromPointer: g }, { M: true });
  }, e: (A, I) => {
    I = y(I);
    var B = I === "std::string";
    N(A, { name: I, fromWireType: function(g) {
      ...
      if (B)
        ...
        for (u = Array(C2), t = 0; t < C2; ++t)
          u[t] = String.fromCharCode(h[i + t]);
        u = u.join("");
      }
      return G(g), u;
    }, toWireType: function(g, C2) {
      C2 instanceof ArrayBuffer && (C2 = new Uint8Array(C2));
      var i, r = typeof C2 == "string";
      if (!(r || C2 instanceof Uint8Array || C2 instanceof Uint8ClampedArray || C2 instanceof Int8Array))
        throw new w("Cannot pass non-string to std::string");
      var t;
      if (B && r)
        for (i = t = 0; i < C2.length; ++i) {
          var E = C2.charCodeAt(i);
      ...
      if (i = t, t = BA(4 + i + 1), E = t + 4, f[t >> 2] = i, B && r) {
        if (r = E, E = i + 1, i = h, 0 < E) {
          ...
          for (var o = 0; o < C2.length; ++o) {
            var a = C2.charCodeAt(o);
            if (55296 <= a && 57343 >= a) {
              var n = C2.charCodeAt(++o);
    ...
    if (B = y(B), I === 2)
      var g = $A, C2 = _A, i = AI, r = () => K, t = 1;
    else
      I === 4 && (g = II, C2 = BI, i = gI, r = () => f, t = 2);
    N(A, { name: B, fromWireType: (E) => {
      ...
      return f[n >> 2] = a >> t, C2(o, n + 4, a + I), E !== null && E.push(G, n), n;
    }, argPackAdvance: 8, readValueFromPointer: lA, C(E) {
      G(E);
    } });
  }, m: (A, I) => {
    I = y(I), N(A, { N: true, name: I, argPackAdvance: 0, fromWireType: () => {
    }, toWireType: () => {
    } });
  }, g: wA, j: (A) => {
    4 < A && (l.get(A).I += 1);
    ...
    for (var B = 1; 4 >= B; B *= 2) {
      ...
      g = Math.max(A, g);
      A: {
        C2 = (C2.min.call(C2, 2147483648, g + (65536 - g % 65536) % 65536) - P.buffer.byteLength + 65535) / 65536;
        try {
          P.grow(C2), rA();
          var i = 1;
          break A;
    ...
    function A(B) {
      var _a2;
      return U = B.exports, P = U.r, rA(), IA = U.w, eA.unshift(U.s), W--, (_a2 = Q.monitorRunDependencies) == null ? void 0 : _a2.call(Q, W), W == 0 && q && (B = q, q = null, B()), U;
    }
    var I = { a: QI };
    if (W++, (_a = Q.monitorRunDependencies) == null ? void 0 : _a.call(Q, W), Q.instantiateWasm)
      try {
  ...
  function pA() {
    function A() {
      if (!V && (V = true, Q.calledRun = true, !CA)) {
...
}, L(k, "codecId", "lz4"), L(k, "DEFAULT_ACCELERATION", QA), L(k, "max_buffer_size", Z), k);
var DI = aI;
export {
  DI as default
};
//# sourceMappingURL=lz4-06c5cf38-FNQ3RMYI.js.map
