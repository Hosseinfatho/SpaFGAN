...
// node_modules/vitessce/dist/lerc-d288eed3.js
    ...
    var Y = function() {
      ...
      var A = function(r, o, a, i, h) {
        ...
        for (var o = r.pixels.numBlocksX * r.pixels.numBlocksY, a = {}, i = 0; i < o; i++) {
          ...
          h.encoding === 0 ? a.float32 = true : h.encoding === 1 ? a[h.bitsPerPixel] = true : a[0] = true;
        }
        ...
        if (i.fileVersion = n.getInt32(0, true), i.imageType = n.getInt32(4, true), i.height = n.getUint32(8, true), i.width = n.getUint32(12, true), i.maxZError = n.getFloat64(16, true), o += 24, !a)
          if (n = new DataView(r, o, 16), i.mask = {}, i.mask.numBlocksY = n.getUint32(0, true), i.mask.numBlocksX = n.getUint32(4, true), i.mask.numBytes = n.getUint32(8, true), i.mask.maxValue = n.getFloat32(12, true), o += 16, i.mask.numBytes > 0) {
            var f = new Uint8Array(Math.ceil(i.width * i.height / 8));
            n = new DataView(r, o, i.mask.numBytes);
            var v = n.getInt16(0, true), u = 2, m = 0;
            do {
              if (v > 0)
                for (; v--; )
                  f[m++] = n.getUint8(u++);
        ...
        n = new DataView(r, o, 16), i.pixels = {}, i.pixels.numBlocksY = n.getUint32(0, true), i.pixels.numBlocksX = n.getUint32(4, true), i.pixels.numBytes = n.getUint32(8, true), i.pixels.maxValue = n.getFloat32(12, true), o += 16;
          ...
          for (var y = 0; y < w; y++) {
            ...
            if (c !== 0 && c !== 2) {
              if (c >>= 6, p.offsetType = c, c === 2)
                ...
                p.offset = n.getInt16(1, true), x += 2;
              else if (c === 0)
                p.offset = n.getFloat32(1, true), x += 4;
              else
              ...
              if (p.encoding === 1)
                if (c = n.getUint8(x), x++, p.bitsPerPixel = c & 63, c >>= 6, p.numValidPixelsType = c, c === 2)
                  ...
                  p.numValidPixels = n.getUint16(x, true), x += 2;
                else if (c === 0)
                  p.numValidPixels = n.getUint32(x, true), x += 4;
                else
      ...
      var F = {
        ...
        readHeaderInfo: function(t, e) {
          ...
          r += 6;
          var i = new DataView(t, r, 8), h = i.getInt32(0, true);
          a.fileVersion = h, r += 4, h >= 3 && (a.checksum = i.getUint32(4, true), r += 4), i = new DataView(t, r, 12), a.height = i.getUint32(0, true), a.width = i.getUint32(4, true), r += 8, h >= 4 ? (a.numDims = i.getUint32(8, true), r += 4) : a.numDims = 1, i = new DataView(t, r, 40), a.numValidPixel = i.getUint32(0, true), a.microBlockSize = i.getInt32(4, true), a.blobSize = i.getInt32(8, true), a.imageType = i.getInt32(12, true), a.maxZError = i.getFloat64(16, true), a.zMin = i.getFloat64(24, true), a.zMax = i.getFloat64(32, true), r += 40, e.headerInfo = a, e.ptr = r;
          var n, f;
        ...
        readMask: function(t, e) {
          ...
          if (n.numBytes = h.getUint32(0, true), r += 4, (i === 0 || a === i) && n.numBytes !== 0)
            throw "invalid mask";
          var f, v;
          if (i === 0)
            ...
            var u = h.getInt16(0, true), m = 2, g = 0, l = 0;
            do {
              if (u > 0)
                for (; u--; )
                  f[g++] = h.getUint8(m++);
        ...
        readDataOneSweep: function(t, e, r, o) {
          ...
          if (u.length === n * h)
            o ? e.pixels.resultPixels = A.swapDimensionOrder(u, n, h, r, true) : e.pixels.resultPixels = u;
          else {
        ...
        readHuffmanTree: function(t, e) {
          ...
          var i = o.getInt32(4, true), h = o.getInt32(8, true), n = o.getInt32(12, true);
          if (h >= n)
            return false;
        ...
        decodeBits: function(t, e, r, o, a) {
          {
            ...
            if (g === 1)
              ...
              w = v.getUint16(n, true), n += 2;
            else if (g === 4)
              w = v.getUint32(n, true), n += 4;
            else
              throw "Invalid valid pixel count type";
            ...
            if (l) {
              ...
              e.counter.bitstuffer++, I = s, e.ptr += n, I > 0 && (x = Math.ceil(w * I / 8), L = Math.ceil(x / 4), d = new ArrayBuffer(L * 4), y = new Uint8Array(d), y.set(new Uint8Array(t, e.ptr, x)), D = new Uint32Array(d), e.ptr += x, h >= 3 ? o == null ? F.originalUnstuff2(D, r, I, w) : F.unstuff2(D, r, I, w, false, o, k, M) : o == null ? F.originalUnstuff(D, r, I, w) : F.unstuff(D, r, I, w, false, o, k, M));
          }
        },
        ...
        getOnePixel: function(t, e, r, o) {
          ...
          switch (r) {
            ...
            case 2:
              ...
              break;
            case 3:
              a = o.getUint16(e, true);
              break;
            case 4:
              a = o.getInt32(e, true);
              break;
            case 5:
              a = o.getUInt32(e, true);
              break;
            case 6:
              a = o.getFloat32(e, true);
              break;
            case 7:
              a = o.getFloat64(e, true);
              break;
            default:
...
var ue = ie.exports;
var ve = Gs(ue);
var we = class extends xvi {
  constructor(Y) {
    super(), this.planarConfiguration = typeof Y.PlanarConfiguration < "u" ? Y.PlanarConfiguration : 1, this.samplesPerPixel = typeof Y.SamplesPerPixel < "u" ? Y.SamplesPerPixel : 1, this.addCompression = Y.LercParameters[QWr.AddCompression];
  }
  decodeBlock(Y) {
...
vitessce/dist/lerc-d288eed3.js:
  (* Copyright 2015-2021 Esri. Licensed under the Apache License, Version 2.0 (the "License"); you may not use this file except in compliance with the License. You may obtain a copy of the License at http://www.apache.org/licenses/LICENSE-2.0 @preserve *)
*/
//# sourceMappingURL=lerc-d288eed3-BGNQ637G.js.map
